...
Snapshot tables today: `cashflowPoints`, `categoryRevenueAllocations`, `financeCosMonthly`, `financeRevenueMonthly`, `normalizedCostLineActuals`, `normalizedCostLines`, `normalizedRevenueLines`, `projectRevenueSummary`, `trackerProjectMetadata`, `trackerRevenueSummary`.
