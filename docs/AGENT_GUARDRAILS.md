...
Snapshot tables today: `cashflowPoints`, `categoryRevenueAllocations`, `financeCosMonthly`, `financeRevenueMonthly`, `financialReconciliation`, `manualAdjustments`, `normalizedCostLineActuals`, `normalizedCostLines`, `normalizedRevenueLines`, `projectRevenueSummary`, `trackerProjectMetadata`, `trackerRevenueSummary`.
