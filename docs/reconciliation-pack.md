...
| `cost_lines_null_legacy_fk` | _(removed — replaced by `cost_lines_native_promoted` INFO check)_ |
| `revenue_lines_null_legacy_fk` | _(removed — replaced by `revenue_lines_native_promoted` INFO check)_ |
