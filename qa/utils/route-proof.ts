...
export const PRIORITY_ROUTE_EXPECTATIONS: RouteProofExpectation[] = [
  ...
  { routeId: "executionReview", label: "Execution", expectedHeadingOrAnchor: /(Execution|data-testid)/i, expectedPrimaryActionOrWidget: /(Button|Table|input|Link\s+href=)/i, todo: "Add Execution control-tower workflow tests for filters, drilldowns, and allocation links." },
