...
export const PRIORITY_ROUTE_EXPECTATIONS: RouteProofExpectation[] = [
  ...
  { routeId: "pmDashboard", label: "PM Dashboard", expectedHeadingOrAnchor: /(PM Dashboard|Project Manager|data-testid)/i, expectedPrimaryActionOrWidget: /(Button|Project|KPI|input|Link\s+href=)/i, todo: "Add PM-specific prioritisation and escalation workflow tests." },
  ...
  { routeId: "handoverControl", label: "Handover Control", expectedHeadingOrAnchor: /(Handover|Gate|data-testid)/i, expectedPrimaryActionOrWidget: /(Button|Checklist|Link\s+href=|input|Table)/i, todo: "Add end-to-end handover gate progression tests." },
];
