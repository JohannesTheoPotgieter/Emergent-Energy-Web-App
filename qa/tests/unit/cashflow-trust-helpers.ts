export function isRowStale(lastImportedAt: string | null | undefined): boolean {
...
export function isQbDivergent(appAmount: number | null, qbAmount: number | null): boolean {
