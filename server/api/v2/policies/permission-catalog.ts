export const PERMISSION_CATALOG = {
  "*": ["*"],
  CCO: ["dashboard.read", "projects.read", "projects.write", "finance.read", "engineering.read", "quality.read", "pm.read", "development.read", "development.write", "procurement.read"],
  ...
  PROGRAM_FINANCE_MANAGER: ["dashboard.read", "projects.read", "finance.read", "finance.write", "pm.read", "engineering.read", "procurement.read", "procurement.write", "invoice.write", "work_items.write"],
  ...
  SSEG_MANAGER: ["dashboard.read", "projects.read", "hse.read", "hse.write", "quality.read", "engineering.read", "work_items.read", "pm.read"],
