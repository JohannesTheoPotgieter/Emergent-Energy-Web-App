...
export function registerTrRegisterRoutes(app: Express) {
  ...
  app.post("/api/tr-register/seed", requireAuth, requireManager, async (_req: Request, res: Response) => {
    try {
      const SEED_DATA = [
        { trId: "TR026", department: "Finance", actionDescription: "Magic Company Tracker & COS", ragStatus: "Red" as const, owners: ["Roedolph"], support: [], dateRaised: "28-Jan", dueDate: "30-Jan", status: "Completed" as const, dateCompleted: "15-Feb", outcomeComments: "", supportingInfo: "" },
        ...
        { trId: "TR029", department: "Planning", actionDescription: "AdHoc Tracker", ragStatus: "Green" as const, owners: ["Roedolph"], support: [], dateRaised: "30-Jan", dueDate: "06-Feb", status: "Completed" as const, dateCompleted: "15-Feb", outcomeComments: "", supportingInfo: "" },
        { trId: "TR010", department: "Planning", actionDescription: "Set up Westway Tracker", ragStatus: "Green" as const, owners: ["Roedolph"], support: [], dateRaised: "14-Jan", dueDate: "15-Jan", status: "Completed" as const, dateCompleted: "15-Jan", outcomeComments: "", supportingInfo: "" },
        ...
        { trId: "TR012", department: "Compliance", actionDescription: "PR Eng sign off Rural Retail Portfolio", ragStatus: "Green" as const, owners: ["Peet"], support: [], dateRaised: "14-Jan", dueDate: "16-Jan", status: "Completed" as const, dateCompleted: "28-Jan", outcomeComments: "", supportingInfo: "" },
        { trId: "TR013", department: "Planning", actionDescription: "Koogan Plastics Timeline", ragStatus: "Green" as const, owners: ["Roedolph"], support: [], dateRaised: "15-Jan", dueDate: "23-Jan", status: "Completed" as const, dateCompleted: "19-Jan", outcomeComments: "", supportingInfo: "" },
        { trId: "TR014", department: "Finance", actionDescription: "The Engineering Hub Check and Balance", ragStatus: "Green" as const, owners: ["Roedolph"], support: [], dateRaised: "15-Jan", dueDate: "21-Jan", status: "Completed" as const, dateCompleted: "22-Jan", outcomeComments: "Sent an email to them, waiting for feedback", supportingInfo: "" },
        ...
        { trId: "TR018", department: "Planning", actionDescription: "Switchboard orders", ragStatus: "Red" as const, owners: ["Roedolph"], support: [], dateRaised: "20-Jan", dueDate: "24-Jan", status: "Completed" as const, dateCompleted: "22-Jan", outcomeComments: "", supportingInfo: "" },
        ...
        { trId: "TR022", department: "Engineering", actionDescription: "Update engineering board with allocated panels", ragStatus: "Amber" as const, owners: ["Roedolph"], support: [], dateRaised: "21-Jan", dueDate: "21-Jan", status: "Completed" as const, dateCompleted: "22-Jan", outcomeComments: "", supportingInfo: "" },
        ...
        { trId: "TR036", department: "Planning", actionDescription: "Update email about whatsapp group change & Photo folder", ragStatus: "Green" as const, owners: ["Roedolph"], support: [], dateRaised: "10-Feb", dueDate: "13-Feb", status: "Completed" as const, dateCompleted: "16-Feb", outcomeComments: "", supportingInfo: "" },
        { trId: "TR037", department: "Planning", actionDescription: "Boundary Terraces RMA for Breaker", ragStatus: "Green" as const, owners: ["Roedolph"], support: [], dateRaised: "11-Feb", dueDate: "18-Feb", status: "Active" as const, dateCompleted: "", outcomeComments: "Breaker must be dropped off at office then taken to SWB", supportingInfo: "" },
        { trId: "TR027", department: "Planning", actionDescription: "Westway viability", ragStatus: "Green" as const, owners: ["Roedolph"], support: [], dateRaised: "28-Jan", dueDate: "05-Feb", status: "Completed" as const, dateCompleted: "08-Feb", outcomeComments: "", supportingInfo: "" },
        { trId: "TR028", department: "Construction", actionDescription: "Shoprite Sibasa damage to roof and rectification plan", ragStatus: "Red" as const, owners: ["Roedolph"], support: [], dateRaised: "30-Jan", dueDate: "30-Jan", status: "Completed" as const, dateCompleted: "02-Feb", outcomeComments: "", supportingInfo: "" },
        ...
        { trId: "TR038", department: "Planning", actionDescription: "Dean's email about the MV work at Coega", ragStatus: "Green" as const, owners: ["Roedolph"], support: [], dateRaised: "12-Feb", dueDate: "30-Mar", status: "Active" as const, dateCompleted: "", outcomeComments: "This is for the cable swop for the MV", supportingInfo: "" },
        { trId: "TR041", department: "Planning", actionDescription: "Mondi - Email about JA Electrical's LOG", ragStatus: "Red" as const, owners: ["Roedolph"], support: [], dateRaised: "23-Feb", dueDate: "23-Feb", status: "Active" as const, dateCompleted: "", outcomeComments: "", supportingInfo: "" },
      ];

      const results: Array<{ trId: string; action: string; id: number }> = [];
      for (const seed of SEED_DATA) {
        ...
        const [existing] = await db.select().from(trItems).where(eq(trItems.trId, seed.trId));

        if (existing) {
          const [updated] = await db.update(trItems).set({
            department: seed.department,
            actionDescription: seed.actionDescription,
            ...
            status: seed.status,
            dateCompleted,
            outcomeComments: seed.outcomeComments || null,
            supportingInfo: seed.supportingInfo || null,
            updatedAt: new Date(),
            updatedBy: "pm-register-seed-v1",
          }).where(eq(trItems.trId, seed.trId)).returning();
          results.push({ trId: seed.trId, action: "updated", id: updated.id });
        } else {
          const [created] = await db.insert(trItems).values({
            trId: seed.trId,
            department: seed.department,
            actionDescription: seed.actionDescription,
            ragStatus: seed.ragStatus,
            ...
            outcomeComments: seed.outcomeComments || null,
            supportingInfo: seed.supportingInfo || null,
            createdBy: "pm-register-seed-v1",
            updatedBy: "pm-register-seed-v1",
          }).returning();
          results.push({ trId: seed.trId, action: "created", id: created.id });
        }
      }

      res.json({ success: true, batch: "pm-register-seed-v1", results });
    } catch (err: any) {
      res.status(500).json({ error: err.message });
    }
  });
