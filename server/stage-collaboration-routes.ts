// ============================================================
// STAGE COLLABORATION ROUTES — Access + financial close tracks
//
// DEPRECATION NOTICE (2026-04-14):
// Client commitments, client updates, and project query endpoints are owned by
// collaboration-workflow-routes.ts. This file intentionally keeps only
// non-overlapping endpoints to avoid load-order-dependent duplicates.
// ============================================================
...
export function registerStageCollaborationRoutes(app: Express): void {
  // Collaboration workflow (commitments/updates/queries) lives in
  // collaboration-workflow-routes.ts.
