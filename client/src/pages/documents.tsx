...
/**
 * /documents — generic company-wide SharePoint browser.
 *
 * Per-project documents are now bound per discipline via the browse-and-bind
 * flow on each project's documents page (DisciplinePanel / DisciplineFolderBinder),
 * so this surface is company-scope only.
 */
export default function DocumentsPage() {
  ...
  const target: BrowseTarget | null = useMemo(
    () => (companyRootId != null ? { kind: "company", rootId: companyRootId } : null),
    [companyRootId],
  );
  ...
  return (
    <PageLayout
      ...
      header={
        <PageHeader
          title="Documents"
          subtitle="Company-wide SharePoint browser."
        />
      }
    >
