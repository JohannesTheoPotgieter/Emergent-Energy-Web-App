  ...
  return (
    <div className="container mx-auto p-6 space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold">Engineering Report — Month Comparison</h1>
      </div>
                  ...
                  {compareMetrics.map((m, i) => {
                    ...
                    return (
                      <tr key={i} className="border-b hover:bg-muted/30">
                        ...
                        <td className="px-3 py-2 text-right"><DeltaIndicator value={delta} higherIsBetter={m.higherIsBetter} /></td>
                      </tr>
                    );
                  })}
                </tbody>
