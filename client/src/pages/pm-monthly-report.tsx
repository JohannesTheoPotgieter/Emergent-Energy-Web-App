            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                {(data.costSummary || []).length === 0 ? (
                  <tr><td colSpan={6} className="px-2 py-4"><EmptyState icon={AlertTriangle} title="No cost summary rows" description="No budget/actual variance data is available for the selected month." /></td></tr>
        ...
        <CardContent>
          <div className="overflow-x-auto max-h-[520px] overflow-y-auto border rounded-lg">
            <table className="w-full text-xs">
              ...
              <tbody>{data.length === 0 ? (<tr><td colSpan={6} className="px-2 py-4"><EmptyState icon={AlertTriangle} title="No project status rows" description="No project status signals were generated for this month." /></td></tr>) : data.map((r: any, i: number) => (
