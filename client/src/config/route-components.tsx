  ...
  return lazy(() =>
    importFn().catch((error: Error) => {
      ...
      return new Promise<{ default: ComponentType<any> }>((resolve) =>
        ...
        () =>
          lazyWithRetry(importFn, retries - 1) as unknown as Promise<{
...
const EngineeringDeliverablesV2Page = lazyWithRetry(
  () => import('@/pages/engineering-deliverables-v2'),
);
...
const ClientProjectDepartmentsPage = lazyWithRetry(
  () => import('@/pages/client-project-departments'),
);
...
const EngMonthlyReportHistoryPage = lazyWithRetry(
  () => import('@/pages/engineering-monthly-report-history'),
);
const EngMonthlyReportComparePage = lazyWithRetry(
  () => import('@/pages/engineering-monthly-report-compare'),
);
const EngMonthlyReportProjectPage = lazyWithRetry(
  () => import('@/pages/engineering-monthly-report-project'),
);
...
export const ROUTE_COMPONENT_KEYS = Object.keys(ROUTE_COMPONENTS);
