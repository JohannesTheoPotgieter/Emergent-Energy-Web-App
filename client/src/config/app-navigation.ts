...
export const TOP_SECTIONS: TopSection[] = [
  ...
  },
  {
    ...
    match: (pathname) => startsWithAny(pathname, [
      "/execution", "/project", "/lifecycle-board",
    ]),
    secondary: [
      { label: "Board", path: "/execution" },
      { label: "Activity Planning", path: "/execution/milestones" },
...
export const ROLE_VISIBLE_SECTIONS: Record<CompanyRole, SectionKey[]> = {
  ...
  PROGRAM_FINANCE_MANAGER:["HOME", "PORTFOLIO", "FINANCE", "PROJECT_DELIVERY", "REPORTS", "PRIORITIES", "ADMIN"],
