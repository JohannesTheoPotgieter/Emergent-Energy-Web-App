...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  ...
  { id: "executionBoard", path: "/execution-board", label: "Execution Dashboard", iconKey: "LayoutDashboard", navGroup: "PROJECT_MANAGEMENT", permissionEntity: "execution_board", showInSidebar: true, routeComponentKey: "ExecutionBoardPage", aliases: ["/execution-dashboard"], labels: { legacy: "Work Plan / Board", redesigned: "Execution Dashboard" }, matchSubRoutes: true },
  ...
  { id: "executionBoardRealisation", path: "/execution-board/realisation", label: "Realisation KPIs", permissionEntity: "execution_board", routeComponentKey: "ExecutionBoardPage" },
  ...
  { id: "programmeReports", path: "/reports/programme", label: "Programme Reports", iconKey: "FileSpreadsheet", navGroup: "PORTFOLIO", permissionEntity: "financials", showInSidebar: true, routeComponentKey: "ProgrammeReportsPage" },
