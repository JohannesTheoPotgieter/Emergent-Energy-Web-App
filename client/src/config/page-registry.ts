...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  ...
  { id: "companyPriorities", path: "/company-priorities", label: "Company Priorities (Legacy)", redirectTo: "/priorities" },
  { id: "priorities", path: "/priorities", label: "Priorities", iconKey: "Flag", navGroup: "EXCO", permissionEntity: "company_priorities", showInSidebar: false, routeComponentKey: "PrioritiesPage" },
