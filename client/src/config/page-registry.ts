...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  ...
  { id: "pdTicketCreate", path: "/pd/tickets/create", label: "Create PD Ticket", navGroup: "PROJECT_DEVELOPMENT", permissionEntity: "pd_tickets", routeComponentKey: "PdTicketCreatePage" },
  { id: "pdTicketDetail", path: "/pd/tickets/:id", label: "PD Ticket Detail", navGroup: "PROJECT_DEVELOPMENT", permissionEntity: "pd_tickets", routeComponentKey: "PdTicketDetailPage" },
  ...
  { id: "myWorkApprovals", path: "/my-work/approvals", label: "Approvals", iconKey: "ClipboardCheck", navGroup: "MY_WORK", type: "alias", permissionEntity: "my_work", showInSidebar: false, redirectTo: "/governance/approvals" },
  ...
  { id: "departmentScores", path: "/department-scores", label: "Department Scores", iconKey: "BarChart3", navGroup: "KNOWLEDGE", type: "alias", permissionEntity: "leaderboard", showInSidebar: false, redirectTo: "/leaderboard?tab=departments" },
