...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  { id: "dashboard", path: "/dashboard", label: "Execution Board", iconKey: "LayoutDashboard", navGroup: "PROJECT_MANAGEMENT", permissionEntity: "execution_board", showInSidebar: true, routeComponentKey: "Dashboard", labels: { legacy: "Execution Dashboard" } },
  ...
  { id: "cashflow", path: "/cashflow", label: "Cashflow", iconKey: "Wallet", navGroup: "FINANCE", permissionEntity: "cashflow", showInSidebar: true, routeComponentKey: "CashflowPage" },
  { id: "revenue", path: "/revenue", label: "Revenue", routeComponentKey: "RevenueTracker" },
  { id: "cos", path: "/cos", label: "COS Tracker", iconKey: "TrendingUp", navGroup: "FINANCE", permissionEntity: "cos", showInSidebar: true, routeComponentKey: "CostTracker" },
  { id: "revenueTracker", path: "/revenue-tracker", label: "Revenue Tracker", iconKey: "TrendingUp", navGroup: "FINANCE", permissionEntity: "revenue_tracker", showInSidebar: true, routeComponentKey: "RevenueTrackerPage" },
  ...
  { id: "myTool", path: "/my-tool", label: "My Tool", iconKey: "Briefcase", navGroup: "EXCO", permissionEntity: "my_tool", showInSidebar: true, routeComponentKey: "MyToolTodayPage", matchSubRoutes: true },
  { id: "myToolWeek", path: "/my-tool/week", label: "My Tool Week", routeComponentKey: "MyToolWeekPage" },
  { id: "myToolBacklog", path: "/my-tool/backlog", label: "My Tool Backlog", routeComponentKey: "MyToolBacklogPage" },
  { id: "myToolSettings", path: "/my-tool/settings", label: "My Tool Settings", routeComponentKey: "MyToolSettingsPage" },
  ...
  { id: "myToolHelp", path: "/my-tool/help", label: "My Tool Help", routeComponentKey: "MyToolHelpPage" },
  { id: "admin", path: "/admin", label: "Admin", permissionEntity: "admin", routeComponentKey: "AdminPage" },
  { id: "adminMyTool", path: "/admin/my-tool-settings", label: "Admin My Tool Settings", permissionEntity: "admin", routeComponentKey: "MyToolAdminSettingsPage" },
  ...
  { id: "engineering", path: "/engineering", label: "Eng Dashboard", iconKey: "Wrench", navGroup: "ENGINEERING", permissionEntity: "engineering", showInSidebar: true, routeComponentKey: "EngineeringDashboardPage", labels: { legacy: "Eng Standup" } },
  ...
  { id: "executionBoard", path: "/execution-board", label: "Execution Board", permissionEntity: "execution_board", routeComponentKey: "ExecutionBoardPage" },
  { id: "myToolMeetings", path: "/my-tool/meetings", label: "My Tool Meetings", routeComponentKey: "MyToolMeetingsPage" },
  { id: "adminSettings", path: "/admin/settings", label: "App Settings", iconKey: "Settings", navGroup: "SYSTEM", permissionEntity: "admin", showInSidebar: true, routeComponentKey: "RoleSettingsPage", labels: { legacy: "Settings" } },
  ...
  { id: "subcontractor", path: "/subcontractor-dashboard", label: "Procurement", iconKey: "Users", navGroup: "FINANCE", permissionEntity: "subcontractors", showInSidebar: true, routeComponentKey: "SubcontractorDashboardPage" },
  { id: "adminActivity", path: "/admin/activity-log", label: "Activity Log", iconKey: "Activity", navGroup: "SYSTEM", permissionEntity: "activity_log", showInSidebar: true, routeComponentKey: "SystemActivityLogPage", labels: { legacy: "Change Audit" } },
  ...
  { id: "adminRoles", path: "/admin/roles", label: "Users & Roles", iconKey: "ShieldAlert", navGroup: "SYSTEM", permissionEntity: "admin_roles", showInSidebar: true, routeComponentKey: "AdminRolesPage", labels: { legacy: "Roles & Permissions" } },
  { id: "leaderboard", path: "/leaderboard", label: "Leaderboard", iconKey: "Trophy", navGroup: "SYSTEM", permissionEntity: "leaderboard", showInSidebar: true, routeComponentKey: "LeaderboardPage" },
  { id: "trRegister", path: "/tr-register", label: "TR Register", redirectTo: "/my-work/tasks" },
  { id: "feedback", path: "/feedback", label: "Feedback & Support", iconKey: "MessageSquareText", navGroup: "SYSTEM", permissionEntity: "feedback", showInSidebar: true, routeComponentKey: "FeedbackPage" },
  { id: "eeInfo", path: "/ee-info", label: "Emergent Energy Info", iconKey: "Leaf", navGroup: "SYSTEM", permissionEntity: "ee_info", showInSidebar: true, routeComponentKey: "EeInfoPage" },
  ...
  { id: "pdDashboard", path: "/pd", label: "PD Dashboard", iconKey: "Sun", navGroup: "PROJECT_DEVELOPMENT", permissionEntity: "pd_dashboard", showInSidebar: true, routeComponentKey: "PdDashboardPage" },
  ...
  { id: "adminKpiTraceability", path: "/admin/kpi-traceability", label: "KPI Traceability", iconKey: "Activity", navGroup: "SYSTEM", permissionEntity: "admin", showInSidebar: true, routeComponentKey: "KpiTraceabilityPage" },
  { id: "adminImportControlTower", path: "/admin/import-control-tower", label: "Import Control Tower", iconKey: "FileSpreadsheet", navGroup: "SYSTEM", permissionEntity: "admin", showInSidebar: true, routeComponentKey: "ImportControlTowerPage" },
  { id: "adminRecovery", path: "/admin/recovery", label: "Recovery Center", iconKey: "ShieldAlert", navGroup: "SYSTEM", permissionEntity: "admin", showInSidebar: true, routeComponentKey: "AdminRecoveryPage" },
  { id: "adminControlCenter", path: "/admin/control-center", label: "Control Center", iconKey: "Gauge", navGroup: "SYSTEM", permissionEntity: "admin", showInSidebar: true, routeComponentKey: "AdminControlCenterPage" },
