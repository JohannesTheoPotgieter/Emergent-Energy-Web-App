...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  ...
  { id: "financeGpCompany", path: "/finance/gp/company", label: "Company GP", iconKey: "BarChart3", navGroup: "FINANCE", permissionEntity: "financials", showInSidebar: true, routeComponentKey: "FinanceGpCompanyPage" },
  { id: "financeGp", path: "/finance/gp", label: "GP — by project", iconKey: "BarChart3", navGroup: "FINANCE", permissionEntity: "financials", showInSidebar: true, routeComponentKey: "FinanceGpPage" },
  ...
  { id: "inbox", path: "/inbox", label: "Inbox", iconKey: "Inbox", navGroup: "MY_WORK", permissionEntity: "home", showInSidebar: false, routeComponentKey: "InboxPage" },
  ...
  { id: "programWideAssessment", path: "/reports/program-wide-assessment", label: "Program-wide Assessment", iconKey: "GitCompare", navGroup: "REPORTS", permissionEntity: "excel_vs_app", showInSidebar: true, routeComponentKey: "ProgramWideAssessmentPage" },
  ...
  { id: "financialReviewQueue", path: "/governance/financial-reviews", label: "Financial Review Queue", iconKey: "DollarSign", navGroup: "FINANCE", permissionEntity: "approvals", showInSidebar: true, routeComponentKey: "FinancialReviewQueuePage" },
