...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  ...
  { id: "projects", path: "/projects", label: "Project List", iconKey: "FileSpreadsheet", navGroup: "FINANCE", permissionEntity: "projects", showInSidebar: true, routeComponentKey: "ProjectsSummary" },
