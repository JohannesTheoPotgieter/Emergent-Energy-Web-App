  ...
  return (
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          {showSearch && (
            <div className="flex items-center gap-1.5 px-1.5 pb-1.5 mb-1 border-b sticky top-0 bg-popover z-10">
...
>(({ className, children, ...props }, ref) => {
  ...
  }, [searchTerm, children, props.value])
  ...
  return (
    <SelectPrimitive.Item
      ref={ref}
      className={cn(
        "relative flex w-full cursor-default select-none items-center rounded-sm py-2 pl-2 pr-8 text-sm outline-none transition-colors duration-150 focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 active:bg-accent/70",
        className
      )}
      {...props}
    >
