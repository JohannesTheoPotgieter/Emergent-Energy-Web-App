...
export function RevenueTrackerTab({ projectName }: RevenueTrackerTabProps) {
  ...
  const kpiCards = [
    ...
    },
    {
      ...
      icon: TrendingUp,
      iconBg: ytdVariance >= 0 ? "bg-emerald-50" : "bg-red-50",
      iconColor: ytdVariance >= 0 ? "text-emerald-600" : "text-red-600",
      valueColor: ytdVariance >= 0 ? "text-emerald-600" : "text-red-600",
      borderColor: ytdVariance >= 0 ? "border-emerald-200" : "border-red-200",
    },
    {
      id: "realised-pct",
      label: "Realised %",
      ...
      icon: Activity,
      iconBg: realisedPct >= 0.5 ? "bg-emerald-50" : "bg-amber-50",
      iconColor: realisedPct >= 0.5 ? "text-emerald-600" : "text-amber-600",
      valueColor: realisedPct >= 0.5 ? "text-emerald-600" : "text-amber-600",
      borderColor: realisedPct >= 0.5 ? "border-emerald-200" : "border-amber-200",
    },
  ];
