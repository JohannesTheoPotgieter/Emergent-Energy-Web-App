...
-   **Collaboration**: When flag ON, sidebar links go to dedicated pages: `/collaboration/email`, `/collaboration/teams`, `/collaboration/sharepoint`. Each page is standalone with tag-to-project and convert-to-task actions. No shared "Collaboration" wrapper — each loads independently for fast navigation.
