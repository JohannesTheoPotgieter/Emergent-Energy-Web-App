...
export const ENTITY_REGISTRY: EntityRegistryEntry[] = [
  ...
  },
  {
    entity: 'documents',
    title: "Documents",
    description: "SharePoint document workspace (legacy + v2 bridge)",
    category: 'REPORTING',
    view_roles: ['COO_ADMIN', 'CEO_ADMIN', 'CCO', 'CFO', 'PROGRAM_MANAGER', 'PROGRAM_FINANCE_MANAGER', 'CONSTRUCTION_MANAGER', 'QUALITY_MANAGER', 'ENGINEERING_MANAGER', 'KEY_ACCOUNTS_MANAGER', 'ACCOUNTANT', 'ENGINEER', 'PROJECT_MANAGER_SITE', 'PROJECT_DEVELOPER', 'HSE_MANAGER', 'SSEG_MANAGER'],
    create_roles: ['COO_ADMIN', 'CEO_ADMIN', 'PROGRAM_MANAGER', 'PROJECT_MANAGER_SITE', 'ENGINEERING_MANAGER', 'QUALITY_MANAGER', 'CONSTRUCTION_MANAGER'],
    edit_roles: ['COO_ADMIN', 'CEO_ADMIN', 'PROGRAM_MANAGER', 'PROJECT_MANAGER_SITE', 'ENGINEERING_MANAGER', 'QUALITY_MANAGER', 'CONSTRUCTION_MANAGER'],
    approve_roles: ['COO_ADMIN', 'CEO_ADMIN'],
    override_roles: ['COO_ADMIN', 'CEO_ADMIN'],
    delete_roles: ['COO_ADMIN', 'CEO_ADMIN'],
  },
  {
    ...
    title: "Documents Provision",
    description: "COO/delegate provisioning of project SharePoint roots and folder skeletons",
    category: 'ADMIN',
    view_roles: ['COO_ADMIN', 'CEO_ADMIN', 'PROGRAM_MANAGER'],
    create_roles: ['COO_ADMIN', 'CEO_ADMIN'],
    edit_roles: ['COO_ADMIN', 'CEO_ADMIN'],
  ...
  },
  {
    ...
    description: "Admin taxonomy and approval requirements for document management",
    category: 'ADMIN',
    view_roles: ['COO_ADMIN', 'CEO_ADMIN', 'PROGRAM_MANAGER'],
    create_roles: ['COO_ADMIN', 'CEO_ADMIN'],
    edit_roles: ['COO_ADMIN', 'CEO_ADMIN'],
