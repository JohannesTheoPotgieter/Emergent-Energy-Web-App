...
export const ROLLOUT_FEATURE_FLAGS: FeatureFlagDefinition[] = [
  ...
  {
    key: "migration_bridge_project_read_v1",
    label: "Migration bridge project read v1",
    description: "Controls observability-only parity instrumentation for project read adapters.",
    defaultValue: false,
  },
  {
    key: "migration_bridge_lifecycle_read_v1",
    label: "Migration bridge lifecycle read v1",
    description: "Controls observability-only lifecycle and gate read parity diagnostics.",
    defaultValue: false,
  },
  {
    key: "migration_bridge_approvals_dual_read_v1",
    label: "Migration bridge approvals dual-read v1",
    description: "Controls observability-only approvals parity diagnostics.",
    defaultValue: false,
  },
  {
    key: "migration_bridge_finance_read_v1",
    label: "Migration bridge finance read v1",
    description: "Controls observability-only finance parity diagnostics.",
    defaultValue: false,
  },
  {
    key: "migration_bridge_deliverables_read_v1",
    label: "Migration bridge deliverables read v1",
  ...
  {
    key: "migration_bridge_project_dual_write_v1",
    label: "Migration bridge project dual-write v1",
    description: "Reserved kill-switch for future mirrored project master writes; remains disabled in Phase 1A.",
    defaultValue: false,
  },
  {
