...
export const ROLLOUT_FEATURE_FLAGS: FeatureFlagDefinition[] = [
  ...
  {
    key: "promoted_phase1a_project_read_parity_diagnostics",
    label: "Phase 1A project read parity diagnostics",
    description: "Controls observability-only parity instrumentation for project read adapters.",
    defaultValue: false,
  },
  {
    key: "promoted_phase1a_lifecycle_gates_read_diagnostics",
    label: "Phase 1A lifecycle/gates diagnostics",
    description: "Controls observability-only lifecycle and gate read parity diagnostics.",
    defaultValue: false,
  },
  {
    key: "promoted_phase1a_approvals_read_diagnostics",
    label: "Phase 1A approvals diagnostics",
    description: "Controls observability-only approvals parity diagnostics.",
    defaultValue: false,
  },
  {
    key: "promoted_phase1a_finance_read_diagnostics",
    label: "Phase 1A finance diagnostics",
    description: "Controls observability-only finance parity diagnostics.",
    defaultValue: false,
  },
  {
    key: "promoted_phase1a_deliverables_read_diagnostics",
    label: "Phase 1A deliverables diagnostics",
    description: "Controls observability-only deliverables parity diagnostics.",
    defaultValue: false,
  },
  {
    key: "promoted_phase1a_party_contact_read_diagnostics",
    label: "Phase 1A party/contact diagnostics",
    description: "Controls observability-only party and contact parity diagnostics.",
    defaultValue: false,
  },
  {
    key: "promoted_phase1a_reconciliation_endpoints",
    label: "Phase 1A reconciliation endpoints",
    description: "Controls admin/manual-run reconciliation endpoints for Phase 1A parity checks.",
    defaultValue: false,
  },
  {
