...
export const DEFAULT_ROLE_PERMISSIONS: InsertRolePermission[] = [
  ...
  { role: "PROJECT_DEVELOPER", label: "Project Developer", description: "Project developer — manages project development, cost proposals, and client relations", sections: ["COCKPIT", "PROJECTS", "MONEY", "DELIVERY", "GOVERNANCE", "INFORMATION"], canManageUsers: false, canManageRoles: false, canEditData: true, isSystem: true },
