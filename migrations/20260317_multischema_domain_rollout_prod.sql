...
-- PROD PATCH: eng_stage_templates has purpose (not description) and sort_order (not sequence), no updated_at
...
SELECT id, name, purpose, sort_order, is_active, COALESCE(created_at, NOW()), NOW()
